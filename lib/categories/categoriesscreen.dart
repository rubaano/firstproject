...
import 'package:firstpro/categories/modelcategories.dart';
...
import 'package:firstpro/product/productscreen.dart';
...
class Categories extends StatelessWidget {
 //var b= ShopCubit.get(context).categoriesModel.data.data[index].id;
  ...
  Widget build(BuildContext context) {
    print('screen');
    print(ShopCubit.get(context).categoriesModel.data.data.length);
    return Scaffold(
